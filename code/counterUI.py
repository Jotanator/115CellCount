...
def showFileUploadButton(root, canvas, outputHandler):
    label2=tk.Label(root, text="Browse for image:")
    label2.config(font=("helvetica", 10))

    canvas.create_window(500, 50, window=label2)

    browseButton=tk.Button(text="Browse", command= lambda: (browseFilesys(root, canvas, outputHandler)), bg="brown", fg="white", font=("helvetica", 9, "bold"))
